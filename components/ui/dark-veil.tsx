...
void main(){
    ...
    float useColorTint=step(0.001,length(uBaseColor-vec3(1.0)));
    vec3 colorTinted=uBaseColor*intensity*1.5;
    col.rgb=mix(col.rgb,colorTinted,useColorTint);
...
export default function DarkVeil({
  ...
  useEffect(() => {
    const baseColor = color ? hexToRgb(color) : [1, 1, 1];
