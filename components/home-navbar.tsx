...
export default function HomeNavbar() {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-50">
      ...
      <div className="absolute top-2 right-0 left-0 mx-auto flex h-16 max-w-3xl items-center justify-between rounded-xl border border-dashed bg-background/75 px-3 shadow-lg backdrop-blur-sm">
